  ...
  <v-card class="overflow-hidden">
    ...
    <div v-if="data" class="d-flex justify-space-evenly stats">
      <div class="d-flex flex-column">
        ...
        <p v-if="data.NetTimeMs !== data.TimeMs" class="body-2 text-center">
          {{ formattedBaseTime }}
        </p>
        <p v-if="data.TimeBenefitBlocks" class="body-2 green--text text-center">
          {{ formattedTimeBenefit }}
        </p>
        <p v-if="data.TimePenaltyBlocks" class="body-2 red--text text-center">
          {{ formattedTimePenalty }}
        </p>
        <p
          v-if="data.NetTimeMs"
          class="body-1 primary--text text-center font-weight-bold"
        >
          {{ formattedNetTime }}
        </p>
      </div>
      <div class="d-flex flex-column">
        ...
        <p v-if="data.NetMoves !== data.Moves" class="body-2 text-center">
          {{ data.Moves }}
        </p>
        <p v-if="data.MoveBenefitBlocks" class="body-2 green--text text-center">
          {{ formattedMoveBenefit }}
        </p>
        <p v-if="data.MovePenaltyBlocks" class="body-2 red--text text-center">
